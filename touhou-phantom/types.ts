...
export interface PlayerStats {
  ...
  critRate: number;     // Critical hit chance (0.0 to 1.0)
  critDamage: number;   // Critical damage multiplier (default 1.5 = 150%)
  weaponSlots: number;  // Max weapon slots (default 6)
  passiveSlots: number; // Max passive slots (default 6)
}
...
export interface Weapon {
  ...
  evolvesInto?: string; // ID of evolved weapon (at level 8)
}
